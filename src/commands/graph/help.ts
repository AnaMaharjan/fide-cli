    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "  - `graph query save` writes locally by default; add `--workspace` to save into the hosted workspace query catalog.",
          "  - Hosted graph/query commands accept `--profile` and can also resolve context from project `.fide/settings.json`.",
        ],
      },
    ],
  });
