    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "  fide batches write --transformer .fide/transformers/blocks/organization/structure.json --data .fide/data/organization/structure",
      ...
      },
      {
        ...
        items: [
          ...
          "  - Prefer the top-level `fide query ...`, `fide transformers ...`, and `fide batches ...` surfaces for local authoring.",
        ],
      },
    ],
  });
