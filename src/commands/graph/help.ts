    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "  - Hosted graph/query commands accept `--profile` and can inherit `profile` or `workspaceId` from project `.fide/settings.json`.",
          ...
          "  - Runtime commands (`query`, `build`) operate on configured graphs and query catalogs.",
        ],
      },
    ],
  });
